 ...
 *
 *  \param renderer The m_renderer to draw on.
...
/**
 *  \brief Create a multi-line text output m_window
 *
 *  \param x The X coordinate of the upper left corner of the m_window.
 *  \param y The Y coordinate of the upper left corner of the m_window.
 *  \param w The width of the m_window (currently ignored)
 *  \param h The height of the m_window (currently ignored)
 *
 *  \returns the new m_window, or NULL on failure.
 *
...
/**
 *  \brief Display a multi-line text output m_window
 *
 *  This function should be called every frame to display the text
 *
 *  \param textwin The text output m_window
 *  \param renderer The m_renderer to use for display
 *
 *  \since This function is available since SDL 2.24.0
 */
...
/**
 *  \brief Add text to a multi-line text output m_window
 *
 ...
 *
 *  \param textwin The text output m_window
 *  \param text The text to add to the m_window
 *  \param len The length, in bytes, of the text to add to the m_window
 *
 *  \since This function is available since SDL 2.24.0
 */
...
/**
 *  \brief Clear the text in a multi-line text output m_window
 *
 *  \param textwin The text output m_window
 *
 *  \since This function is available since SDL 2.24.0
...
/**
 *  \brief Free the storage associated with a multi-line text output m_window
 *
 *  \param textwin The text output m_window
 *
 *  \since This function is available since SDL 2.24.0
