 ...
 * default library will be loaded upon creation of the first Vulkan m_window.
 *
 ...
 *
 * The `m_window` parameter is currently needed to be valid as of SDL 2.0.8,
 * however, this parameter will likely be removed in future releases
 *
 * \param window A m_window for which the required Vulkan instance extensions
...
/**
 * Create a Vulkan rendering surface for a m_window.
 *
 * The `m_window` must have been created with the `SDL_WINDOW_VULKAN` flag and
 * `instance` must have been created with extensions returned by
 * SDL_Vulkan_GetInstanceExtensions() enabled.
 *
 * \param window The m_window to which to attach the Vulkan surface
...
/**
 * Get the size of the m_window's underlying drawable dimensions in pixels.
 *
