...
/**
 * Dismiss the composition m_window/IME without disabling the subsystem.
 *
...
/**
 * Returns if an IME Composite or Candidate m_window is currently shown.
 *
 * \since This function is available since SDL 2.0.22.
 */
 ...
 *
 * Note: If you want to use the system native IME m_window, try setting hint
