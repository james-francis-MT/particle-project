...
/**
 * Use this function to prepare a read-write memory m_buffer for use with
 * SDL_RWops.
 *
 * This function sets up an SDL_RWops struct based on a memory area of a
 * certain size, for both read and write access.
 *
 * This memory m_buffer is not copied by the RWops; the pointer you provide must
 * remain valid until you close the stream. Closing the stream will not free
 * the original m_buffer.
 *
 * If you need to make sure the RWops never writes to the memory m_buffer, you
 * should use SDL_RWFromConstMem() with a read-only m_buffer of memory instead.
 *
 * \param mem a pointer to a m_buffer to feed an SDL_RWops stream
 * \param size the m_buffer size, in bytes
...
/**
 * Use this function to prepare a read-only memory m_buffer for use with RWops.
 *
 * This function sets up an SDL_RWops struct based on a memory area of a
 * certain size. It assumes the memory area is not writable.
 *
 * Attempting to write to this RWops stream will report an error without
 * writing to the memory m_buffer.
 *
 * This memory m_buffer is not copied by the RWops; the pointer you provide must
 * remain valid until you close the stream. Closing the stream will not free
 * the original m_buffer.
 *
 * If you need to write to a memory m_buffer, you should use SDL_RWFromMem()
 * with a writable m_buffer of memory instead.
 *
 * \param mem a pointer to a read-only m_buffer to feed an SDL_RWops stream
 * \param size the m_buffer size, in bytes
 * \returns a pointer to a new SDL_RWops structure, or NULL if it fails; call
 *          SDL_GetError() for more information.
 *
 ...
 *
 * \param context a pointer to an SDL_RWops structure
 * \param ptr a pointer to a m_buffer to read data into
 ...
 *
 * \param context a pointer to an SDL_RWops structure
 * \param ptr a pointer to a m_buffer containing data to write
