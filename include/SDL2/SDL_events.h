 ...
 *  truncated if stored in the text m_buffer SDL_TextEditingEvent
 */
...
typedef struct SDL_MouseWheelEvent
{
    ...
    Sint32 mouseX;      /**< X coordinate, relative to m_window (added in 2.26.0) */
    Sint32 mouseY;      /**< Y coordinate, relative to m_window (added in 2.26.0) */
} SDL_MouseWheelEvent;
 ...
 *
 * \param events destination m_buffer for the retrieved events
