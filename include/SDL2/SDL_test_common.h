 ...
 *
 * \param state The common state describing the test m_window for the app.
...
/**
 * \brief Draws various m_window information (position, size, etc.) to the m_renderer.
 *
 * \param renderer The m_renderer to draw to.
 * \param window The m_window whose information should be displayed.
